...
;;;   http://users-cs.au.dk/danvy/IFP16/Lecture-notes/week-05_self-interpreter.html
...
(define Test-4
  (lambda (candidate representation-of-candidate e v)
    (errorf 'Test-4 "not implemented yet")))

(define Test-5
  (lambda (candidate representation-of-candidate e v)
    (errorf 'Test-5 "not implemented yet")))

(define Test-6
  (lambda (candidate representation-of-candidate e v)
    (errorf 'Test-6 "not implemented yet")))
    ...
    (letrec ([eval
              (lambda (e env)
                (cond
                  ...
                  [(is-lambda-3? e)
                   (errorf 'interpret "not implemented yet: 3-ary lambda-abstractions")]
                  [(is-lambda-4? e)
                   (errorf 'interpret "not implemented yet: 4-ary lambda-abstractions")]
                  [(is-application-0? e)
...
;;; end of week-05_self-interpreter.scm
